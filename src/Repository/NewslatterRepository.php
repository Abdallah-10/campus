...
/**
 * @extends ServiceEntityRepository<Newslatter>
 *
...
class NewslatterRepository extends ServiceEntityRepository
{
    ...
    public function add(Newslatter $entity, bool $flush = false): void
    {
    ...
    public function remove(Newslatter $entity, bool $flush = false): void
    {
