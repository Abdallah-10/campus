 ...
 */
final class Version20230312133917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domaines CHANGE etablissement langue VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE ministere DROP minst');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domaines CHANGE langue etablissement VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE ministere ADD minst VARCHAR(255) DEFAULT NULL');
