 ...
 */
final class Version20230307131812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domaines ADD etablissement VARCHAR(255) DEFAULT NULL, DROP langue');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domaines ADD langue VARCHAR(255) NOT NULL, DROP etablissement');
