 ...
 */
final class Version20230130084807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscription CHANGE organisme organisme VARCHAR(255) NOT NULL, CHANGE age age DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscription CHANGE organisme organisme VARCHAR(255) DEFAULT NULL, CHANGE age age INT NOT NULL');
